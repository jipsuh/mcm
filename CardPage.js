...
// @include     https://www.magiccardmarket.eu/?mainPage=showMetacard*
// @grant       GM_addStyle
// ==/UserScript==
...
function ButtonClickAction (zEvent) {
    ...
    var cusid_ele = document.getElementsByClassName('MKMTable specimenTable');
    var a = cusid_ele[0].innerHTML.search("idInfoUser");
    var reExp = /'\)"/;
	var q;
    console.log(cusid_ele[0].innerHTML.substring(a, a+30));
    var table = cusid_ele[0].getElementsByTagName("a");
    for (var i = 0; i < table.length; ++i) {
        var item = table[i];  
        //item.innerHTML = 'this is value';
        console.log(item.innerHTML);
		q = table[i].innerHTML.search(reExp);                    
    	console.log(table[i].innerHTML.substring(31, q));
    }    
